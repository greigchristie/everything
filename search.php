...
<?php
	...
	//print_r($_GET);
	//echo "</pre>";
	$sql = "SELECT a.artist_name, a.id as artist_id, b.album_title, c.track_title, b.id as album_id, b.album_collection, d.album_artist_name, d.album_artist_id ";
...
//			$sql = $sql . " group by album_id";
	...
	if ($requery == "") {
		...
		while ($row = mysqli_fetch_array($result))
		{
			...
			echo "<td><a href='search.php?albumquery=$albumid'>$trackalbum</a> ($albumcollection)</td>";
			echo "<td></td>";
