...
//Just to see what comments look like!
		...
		//$utrackalbum = urlencode($trackalbum);
			echo "<div id ='row'>";
			echo "<div id='col-xs-8'><p><a href='refined.php?req=trackartist&query=$artistid&sort=albumartist'>$trackartist</a> - <a href='artistview.php?artist=$artistid'>View Albums</a></p></div>";
